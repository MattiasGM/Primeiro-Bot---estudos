...
const exampleEmbed = new EmbedBuilder()
  ...
  .addFields(
    { name: 'Descrição:', value: '*Esqueletos são criaturas agressivas encontradas nas Florestas Negras e nos Pântanos que guardam Câmaras Fúnebres e, às vezes, torres Arruinadas. Eles são, como o próprio nome sugere, restos de esqueletos humanos que desde então foram ressuscitados dos mortos.*' },
    { name: 'Localização: *Florestas Negras/ Pântanos/ Montanhas de Neve.*', value: '\u200B' },
